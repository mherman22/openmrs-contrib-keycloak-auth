...
INSERT INTO users (user_id, uuid, username, password, salt) VALUES (250,'uuid-user-250','legacy-sha1',
...
-- every byte under 0x10: 38 characters starting 'c7e3' where the full digest is 40 starting '0c7e'.
INSERT INTO users (user_id, uuid, username, password, salt) VALUES (251,'uuid-user-251','legacy-oldhex',
...
-- A half-set credential: a password with no salt. OpenMRS hashes the password with the literal text
-- "null" appended, so it cannot authenticate this row either.
INSERT INTO users (user_id, uuid, username, password, salt) VALUES (255,'uuid-user-255','no-salt',
...
INSERT INTO users (user_id, uuid, username, password, salt) VALUES (253,'uuid-user-253','locked-out',
